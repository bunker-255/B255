  ...
  ru: {
    seo: {
      home: {
        ...
        desc: 'BUNKER-255 — инфраструктура развития IT и внедрения в бизнес. Не просто ИТ-решения, а непрерывная интеграция для достижения новых высот. Мир IT — это Bunker-255.',
    ...
    tools: {
      ...
      items: {
        ...
        sun: { title: 'Atmo', status: 'New', desc: 'Инструмент для отдыха и развлечений: трекер солнца, погоды, пляжного отдыха и морского досуга.' },
    ...
    cliTools: {
      title: 'CLI Toolchain',
      subtitle: 'Каталог наших консольных утилит для автоматизации и разработки.',
      projector: {
        name: 'Projector',
        slogan: 'The Ultimate Bridge for Gemini App-Build.',
        desc: 'Автоматизированный инструмент для мгновенной подготовки веб-проектов к деплою. Превращает сырой экспорт из Gemini App-Build в готовый к публикации бандл одной командой.',
        workflowTitle: 'Workflow',
        installTitle: 'Installation',
        usageTitle: 'Usage',
        usage: {
          auto: 'Автоматическая сборка актуального zip архива из загрузок.',
          specific: 'Использовать конкретный zip архив.',
          config: 'Показать текущие пути конфигурации.'
        }
      },
      commands: {
  ...
  en: {
    seo: {
      home: {
        ...
        desc: 'BUNKER-255 is a complete infrastructure for IT development and business integration. Not just solutions, but endless interactions reaching new heights. The IT world is Bunker-255.',
    ...
    tools: {
      ...
      items: {
        ...
        sun: { title: 'Atmo', status: 'New', desc: 'Leisure, beach & weather tool: sun, UV, sea activity and outdoor comfort tracker.' },
    ...
    cliTools: {
      title: 'CLI Toolchain',
      subtitle: 'Catalog of our command-line utilities for automation and development.',
      projector: {
        name: 'Projector',
        slogan: 'The Ultimate Bridge for Gemini App-Build.',
  ...
  he: {
    seo: {
      home: {
        ...
        desc: 'BUNKER-255 היא תשתית מערכתית לפיתוח והטמעת IT בעסקים. זו לא רק שורת פתרונות, אלא אינטראקציה טכנולוגית לכיבוש פסגות חדשות. עולם ההייטק הוא BUNKER-255.',
    ...
    tools: {
      ...
      items: {
        ...
        sun: { title: 'Atmo', status: 'חדש', desc: 'כלי לנופש ופנאי: מעקב שמש, מזג אוויר ותנאי חוף למטיילים ושוחים.' },
    ...
    cliTools: {
      title: 'כלי CLI',
      subtitle: 'קטלוג כלי שורת הפקודה שלנו לאוטומציה ופיתוח.',
      projector: {
        name: 'Projector',
        slogan: 'The Ultimate Bridge for Gemini App-Build.',
        desc: 'כלי אוטומטי להכנה מיידית של פרויקטי ווב לפריסה. הופך ייצוא גולמי מ-Gemini App-Build לחבילה מוכנה לפרסום בפקודה אחת.',
        workflowTitle: 'תהליך עבודה',
        installTitle: 'התקנה',
        usageTitle: 'שימוש',
        usage: {
          auto: 'בנייה אוטומטית של ה-zip המעודכן ביותר מההורדות.',
          specific: 'שימוש בקובץ zip ספציפי.',
          config: 'בדיקת תצורת הנתיבים שלך.'
        }
      },
      commands: {
        linux: 'curl -sSL https://bunker-255.com/cli-tools/projector/install.sh | bash',
